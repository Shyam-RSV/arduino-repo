...
//NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
const char FIREBASE_HOST[]  = "medi-track-nodemcu-default-rtdb.firebaseio.com";
const String FIREBASE_AUTH  = "CGVaqvedvLCz19xmbsmZ0YOhqMBejtdkMB42EZMU";
...
void setup() {
  ...
  Serial.println("neo 6m gps serial initialize");
  delay(3000);
